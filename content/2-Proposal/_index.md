...
| Huynh Nhat Linh    | CI/CD, GitOps, Observability & Report   | Jenkinsfile, pipeline, push image ECR, deploy ECS Fargate, Argo CD, CloudWatch, Hugo report site. | linh.huynhnhat@hcmut.edu.vn     |
