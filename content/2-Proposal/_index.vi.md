...
![Kiến trúc DevSecOps CI/CD Pipeline trên AWS](/images/2-Proposal/devsecops_factory_actual_architecture.png)
...
| Huỳnh Nhật Linh    | CI/CD, GitOps, Observability & Report   | Jenkinsfile, pipeline, push image ECR, deploy ECS Fargate, Argo CD, CloudWatch, Hugo report site. | linh.huynhnhat@hcmut.edu.vn     |
