...
👉 **[https://lamelihuynh.github.io/aws-fcaj-report/](https://lamelihuynh.github.io/aws-fcaj-report/)**
...
| STT | Danh mục | Mô tả |
| :--- | :--- | :--- |
| 1️⃣ | **[Worklog](https://lamelihuynh.github.io/aws-fcaj-report/1-worklog/)** | Nhật ký công việc hàng tuần của nhóm từ Tuần 1 đến Tuần 9 |
| 2️⃣ | **[Proposal](https://lamelihuynh.github.io/aws-fcaj-report/2-proposal/)** | Ý tưởng, mục tiêu và đề xuất kiến trúc giải pháp DevSecOps Factory trên Amazon ECS Fargate |
| 3️⃣ | **[Blogs Posted](https://lamelihuynh.github.io/aws-fcaj-report/3-blogsposted/)** | Tổng hợp các bài blog kỹ thuật chuyên sâu xuất bản trên AWS Study Group |
| 4️⃣ | **[Event Participated](https://lamelihuynh.github.io/aws-fcaj-report/4-eventparticipated/)** | Nhật ký tham gia FCAJ Community Day, AWS Study Tour & các buổi Tech Meetup |
| 5️⃣ | **[Workshop](https://lamelihuynh.github.io/aws-fcaj-report/5-workshop/)** | Hướng dẫn lab thực hành chi tiết từng bước (Step-by-step Lab Guides) với đầy đủ Code Snippets |
| 6️⃣ | **[Self-evaluation](https://lamelihuynh.github.io/aws-fcaj-report/6-self-evaluation/)** | Tự đánh giá năng lực, kết quả thu hoạch và bài học kinh nghiệm |
| 7️⃣ | **[Feedback](https://lamelihuynh.github.io/aws-fcaj-report/7-feedback/)** | Cảm nhận, chia sẻ và đóng góp ý kiến về chương trình thực tập AWS FCAJ |
| 8️⃣ | **[References](https://lamelihuynh.github.io/aws-fcaj-report/8-references/)** | Tài liệu tham khảo, AWS Whitepapers và các liên kết hữu ích |
...
1. **Clone repository bao gồm submodules:**
   ```bash
   git clone --recursive https://github.com/lamelihuynh/aws-fcaj-report.git
   cd aws-fcaj-report
   ```
...
| **Huỳnh Nhật Linh** | CI/CD, GitOps, Observability & Report Site *(Jenkins, Argo CD, CloudWatch, Hugo)* | `linh.huynhnhat@hcmut.edu.vn` | [@lamelihuynh](https://github.com/lamelihuynh) |
